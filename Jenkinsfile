    ...
    stage('Start Sonarqube Analysis') {
      ...
      steps {
        ...
        withSonarQubeEnv('Test_Sonar'){
          ...
          bat 'sonar-scanner.bat -D"sonar.projectKey=sonar-amitsharma09" -D"sonar.sources=." -D"sonar.host.url=http://localhost:9000" -D"sonar.login=c54ad48e7bcee5e569e74e0702555e57f9bbb71a"'
        }
      }
    }
